	...
	public function display_setting( $args = array(), $options ) {
		...
		switch ( $type ) {
			...
			case 'expand_all':
				...
				echo '<a id="' . $this->get_field_id( $id ) . '" style="cursor:pointer;" onclick="jQuery( \'.tw-collapsible-control\' ) . slideToggle(); jQuery( \'.tw-collapsible\' ) . slideToggle();">' . esc_html__( 'Expand/Collapse All Options', 'wootheme-testimonials-to-testimonials' ) . ' &raquo;</a>';
			...
			case 'expand_begin':
				...
				echo '<a id="' . $this->get_field_id( $id ) . '" style="cursor:pointer;" onclick="jQuery( \'div#' . $this->get_field_id( $id ) . '\' ) . slideToggle();" class="tw-collapsible-control">' . esc_html__( 'Expand/Collapse', 'wootheme-testimonials-to-testimonials' ) . ' &raquo;</a>';
