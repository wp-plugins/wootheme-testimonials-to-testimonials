...
EOD;
	...
	public static function notice_donate( $disable_donate = null, $item_name = null ) {
		...
		$text = sprintf( esc_html__( 'Please donate $5 towards ongoing free support and development of the "%1$s" plugin. %2$s', 'wootheme-testimonials-to-testimonials' ), $item_name, self::$donate_button );
